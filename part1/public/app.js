...
createApp({
  setup() {
    ...
    return {
      ...
      logout,
      applications, selectedRequestId, loadApplications,
  ...
  template: `
    ...
    <div v-else-if="page === 'dashboard'">
      ...
      <div v-if="user.role === 'owner'">
        ...
        <!-- NEW: List your own requests and load applications -->
        ...
        <!-- Applications for selected request -->
